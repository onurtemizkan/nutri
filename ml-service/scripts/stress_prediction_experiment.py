...
STRESS_PERSONAS: Dict[StressPersona, StressPersonaConfig] = {
    StressPersona.ELITE_ATHLETE: StressPersonaConfig(
        name="Elite Athlete",
        age=26,
        rhr_baseline=48.0, rhr_variability=2.5,
        hrv_rmssd_baseline=75.0, hrv_sdnn_baseline=90.0, hrv_variability=10.0,
        sleep_duration_baseline=8.5, sleep_quality_baseline=85.0, deep_sleep_pct_baseline=0.22,
        sleep_regularity=0.9,
        baseline_stress_level=0.15, stress_reactivity=0.3, stress_recovery_rate=0.8,
        stress_event_frequency=0.1,
        activity_level="elite", workout_frequency=10.0, overtraining_risk=0.3,
        nutrition_regularity=0.95, late_eating_frequency=0.05, alcohol_frequency=0.5,
        caffeine_sensitivity=0.3,
    ),
    StressPersona.RECREATIONAL_RUNNER: StressPersonaConfig(
        name="Recreational Runner",
        age=34,
        rhr_baseline=58.0, rhr_variability=3.5,
        hrv_rmssd_baseline=55.0, hrv_sdnn_baseline=65.0, hrv_variability=12.0,
        sleep_duration_baseline=7.5, sleep_quality_baseline=75.0, deep_sleep_pct_baseline=0.18,
        sleep_regularity=0.75,
        baseline_stress_level=0.25, stress_reactivity=0.4, stress_recovery_rate=0.6,
        stress_event_frequency=0.15,
        activity_level="active", workout_frequency=4.0, overtraining_risk=0.15,
        nutrition_regularity=0.7, late_eating_frequency=0.15, alcohol_frequency=2.0,
        caffeine_sensitivity=0.5,
    ),
    StressPersona.SEDENTARY_OFFICE: StressPersonaConfig(
        name="Sedentary Office Worker",
        age=42,
        rhr_baseline=72.0, rhr_variability=5.0,
        hrv_rmssd_baseline=32.0, hrv_sdnn_baseline=40.0, hrv_variability=8.0,
        sleep_duration_baseline=6.5, sleep_quality_baseline=60.0, deep_sleep_pct_baseline=0.12,
        sleep_regularity=0.5,
        baseline_stress_level=0.5, stress_reactivity=0.6, stress_recovery_rate=0.4,
        stress_event_frequency=0.25,
        activity_level="sedentary", workout_frequency=0.5, overtraining_risk=0.0,
        nutrition_regularity=0.4, late_eating_frequency=0.4, alcohol_frequency=4.0,
        caffeine_sensitivity=0.7,
    ),
    StressPersona.STRESSED_EXECUTIVE: StressPersonaConfig(
        name="Stressed Executive",
        age=48,
        rhr_baseline=78.0, rhr_variability=6.0,
        hrv_rmssd_baseline=25.0, hrv_sdnn_baseline=32.0, hrv_variability=7.0,
        sleep_duration_baseline=5.5, sleep_quality_baseline=50.0, deep_sleep_pct_baseline=0.10,
        sleep_regularity=0.3,
        baseline_stress_level=0.75, stress_reactivity=0.8, stress_recovery_rate=0.25,
        stress_event_frequency=0.5,
        activity_level="low", workout_frequency=1.0, overtraining_risk=0.0,
        nutrition_regularity=0.3, late_eating_frequency=0.6, alcohol_frequency=6.0,
        caffeine_sensitivity=0.8,
    ),
    StressPersona.HEALTH_ENTHUSIAST: StressPersonaConfig(
        name="Health Enthusiast",
        age=31,
        rhr_baseline=60.0, rhr_variability=3.0,
        hrv_rmssd_baseline=52.0, hrv_sdnn_baseline=62.0, hrv_variability=10.0,
        sleep_duration_baseline=7.8, sleep_quality_baseline=78.0, deep_sleep_pct_baseline=0.19,
        sleep_regularity=0.85,
        baseline_stress_level=0.2, stress_reactivity=0.35, stress_recovery_rate=0.7,
        stress_event_frequency=0.12,
        activity_level="active", workout_frequency=5.0, overtraining_risk=0.1,
        nutrition_regularity=0.9, late_eating_frequency=0.1, alcohol_frequency=1.5,
        caffeine_sensitivity=0.4,
    ),
    StressPersona.NIGHT_SHIFT_NURSE: StressPersonaConfig(
        name="Night Shift Nurse",
        age=35,
        rhr_baseline=68.0, rhr_variability=7.0,
        hrv_rmssd_baseline=35.0, hrv_sdnn_baseline=42.0, hrv_variability=12.0,
        sleep_duration_baseline=6.0, sleep_quality_baseline=55.0, deep_sleep_pct_baseline=0.11,
        sleep_regularity=0.2,  # Very irregular due to shifts
        baseline_stress_level=0.55, stress_reactivity=0.65, stress_recovery_rate=0.35,
        stress_event_frequency=0.4,
        activity_level="moderate", workout_frequency=2.0, overtraining_risk=0.05,
        nutrition_regularity=0.25, late_eating_frequency=0.7, alcohol_frequency=2.0,
        caffeine_sensitivity=0.6,
    ),
    StressPersona.COLLEGE_STUDENT_EXAMS: StressPersonaConfig(
        name="College Student (Exam Period)",
        age=21,
        rhr_baseline=65.0, rhr_variability=5.5,
        hrv_rmssd_baseline=48.0, hrv_sdnn_baseline=55.0, hrv_variability=15.0,
        sleep_duration_baseline=6.0, sleep_quality_baseline=58.0, deep_sleep_pct_baseline=0.14,
        sleep_regularity=0.35,
        baseline_stress_level=0.45, stress_reactivity=0.7, stress_recovery_rate=0.5,
        stress_event_frequency=0.35,
        activity_level="light", workout_frequency=2.0, overtraining_risk=0.05,
        nutrition_regularity=0.35, late_eating_frequency=0.5, alcohol_frequency=4.0,
        caffeine_sensitivity=0.5,
    ),
    StressPersona.NEW_PARENT: StressPersonaConfig(
        name="New Parent",
        age=32,
        rhr_baseline=70.0, rhr_variability=6.5,
        hrv_rmssd_baseline=38.0, hrv_sdnn_baseline=45.0, hrv_variability=14.0,
        sleep_duration_baseline=5.5, sleep_quality_baseline=45.0, deep_sleep_pct_baseline=0.08,
        sleep_regularity=0.15,  # Very fragmented sleep
        baseline_stress_level=0.6, stress_reactivity=0.7, stress_recovery_rate=0.3,
        stress_event_frequency=0.6,  # Baby wake-ups, etc.
        activity_level="low", workout_frequency=1.0, overtraining_risk=0.0,
        nutrition_regularity=0.3, late_eating_frequency=0.5, alcohol_frequency=1.0,
        caffeine_sensitivity=0.7,
    ),
    StressPersona.RETIRED_ACTIVE: StressPersonaConfig(
        name="Retired Active",
        age=67,
        rhr_baseline=62.0, rhr_variability=4.0,
        hrv_rmssd_baseline=35.0, hrv_sdnn_baseline=45.0, hrv_variability=8.0,
        sleep_duration_baseline=7.0, sleep_quality_baseline=70.0, deep_sleep_pct_baseline=0.12,
        sleep_regularity=0.85,
        baseline_stress_level=0.2, stress_reactivity=0.3, stress_recovery_rate=0.5,
        stress_event_frequency=0.08,
        activity_level="moderate", workout_frequency=4.0, overtraining_risk=0.1,
        nutrition_regularity=0.85, late_eating_frequency=0.1, alcohol_frequency=2.0,
        caffeine_sensitivity=0.4,
    ),
    StressPersona.YOGA_PRACTITIONER: StressPersonaConfig(
        name="Yoga Practitioner",
        age=38,
        rhr_baseline=56.0, rhr_variability=2.5,
        hrv_rmssd_baseline=62.0, hrv_sdnn_baseline=72.0, hrv_variability=8.0,
        sleep_duration_baseline=7.8, sleep_quality_baseline=82.0, deep_sleep_pct_baseline=0.20,
        sleep_regularity=0.9,
        baseline_stress_level=0.15, stress_reactivity=0.25, stress_recovery_rate=0.85,
        stress_event_frequency=0.08,
        activity_level="moderate", workout_frequency=5.0, overtraining_risk=0.02,
        nutrition_regularity=0.9, late_eating_frequency=0.05, alcohol_frequency=0.5,
        caffeine_sensitivity=0.3,
    ),
    StressPersona.CHRONIC_STRESS: StressPersonaConfig(
        name="Chronic High Stress",
        age=45,
        rhr_baseline=82.0, rhr_variability=7.0,
        hrv_rmssd_baseline=22.0, hrv_sdnn_baseline=28.0, hrv_variability=6.0,
        sleep_duration_baseline=5.0, sleep_quality_baseline=40.0, deep_sleep_pct_baseline=0.07,
        sleep_regularity=0.25,
        baseline_stress_level=0.85, stress_reactivity=0.9, stress_recovery_rate=0.15,
        stress_event_frequency=0.7,
        activity_level="sedentary", workout_frequency=0.0, overtraining_risk=0.0,
        nutrition_regularity=0.2, late_eating_frequency=0.7, alcohol_frequency=8.0,
        caffeine_sensitivity=0.9,
    ),
    StressPersona.RECOVERING_BURNOUT: StressPersonaConfig(
        name="Recovering from Burnout",
        age=40,
        rhr_baseline=70.0, rhr_variability=5.5,
        hrv_rmssd_baseline=30.0, hrv_sdnn_baseline=38.0, hrv_variability=10.0,
        sleep_duration_baseline=7.5, sleep_quality_baseline=55.0, deep_sleep_pct_baseline=0.11,
        sleep_regularity=0.6,
        baseline_stress_level=0.55, stress_reactivity=0.6, stress_recovery_rate=0.4,
        stress_event_frequency=0.2,
        activity_level="light", workout_frequency=2.0, overtraining_risk=0.05,
        nutrition_regularity=0.6, late_eating_frequency=0.25, alcohol_frequency=2.0,
        caffeine_sensitivity=0.6,
    ),
}
...
class StressDataGenerator:
    ...
    def generate_persona_data(
        ...
        for day_idx in range(num_days):
            ...
            acute_stress = self._calculate_acute_stress(config, state, stress_event, is_weekend)
            ...
            records.append({
                ...
                "training_load_7d": np.mean(state["training_load_7d"][-7:]) if state["training_load_7d"] else 0,
                ...
                # Rolling averages
                "hrv_rmssd_7d_avg": np.mean(state["hrv_7d"][-7:]) if state["hrv_7d"] else hrv_rmssd,
                "rhr_7d_avg": np.mean(state["rhr_7d"][-7:]) if state["rhr_7d"] else rhr,
            })

            # Update state
            self._update_state(
                state, config, hrv_rmssd, rhr, sleep_duration, activity_load, stress_event
            )
    ...
    def _generate_stress_events(
        ...
        state["stress_events_active"] = [
            e for e in state["stress_events_active"]
            if e["end_day"] > day_idx
        ]
    ...
    def _calculate_acute_stress(
        self, config: StressPersonaConfig, state: Dict, stress_event: bool, is_weekend: bool
    ) -> float:
    ...
    def _generate_rhr(
        ...
        rhr = config.rhr_baseline + stress_elevation + sleep_debt_effect + training_effect
    ...
    def _generate_activity_metrics(
        ...
        if self.rng.random() < workout_prob:
            ...
            if config.activity_level == "elite":
                ...
                intensity = self.rng.choice(["HIGH", "MODERATE", "LOW"], p=[0.3, 0.5, 0.2])
            else:
    ...
    def _calculate_stress_score(
        ...
        avg_load = np.mean(state["training_load_7d"][-7:]) if state["training_load_7d"] else 30
...
class StressExperiment:
    ...
    def run_full_experiment(
        ...
        for persona in tqdm(STRESS_PERSONAS, desc="Generating personas"):
            ...
            results["persona_stats"][persona.value] = {
                ...
                "moderate_stress_pct": float((df["stress_category"] == "MODERATE").mean() * 100),
                "high_stress_pct": float((df["stress_category"] == "HIGH").mean() * 100),
            }
        ...
        X_train, X_test, y_reg_train, y_reg_test, y_cls_train, y_cls_test, feature_names = \
        ...
        rf_reg = RandomForestRegressor(n_estimators=100, max_depth=15, random_state=self.seed, n_jobs=-1)
        ...
        rf_cls = RandomForestClassifier(n_estimators=100, max_depth=15, random_state=self.seed, n_jobs=-1)
        ...
        print(classification_report(y_cls_test, rf_cls_pred, target_names=["LOW", "MODERATE", "HIGH"]))
        results["model_results"]["random_forest_classification"] = rf_cls_results

        # Gradient Boosting
        print("\n--- Gradient Boosting Regressor ---")
        gb_reg = GradientBoostingRegressor(n_estimators=100, max_depth=5, random_state=self.seed)
        ...
        importance_per_timestep = rf_reg.feature_importances_.reshape(sequence_length, -1)
        ...
        test_dataset = TensorDataset(X_test_tensor, y_reg_test_tensor, y_cls_test_tensor)
        ...
        lstm_reg_results = self._train_model(
            lstm_reg, train_loader, test_loader, epochs=epochs,
            task="regression"
        )
        ...
        lstm_cls_results = self._train_model(
            lstm_cls, train_loader, test_loader, epochs=epochs,
            task="classification"
        )
        ...
        transformer_reg_results = self._train_model(
            transformer_reg, train_loader, test_loader, epochs=epochs,
            task="regression"
        )
        ...
        transformer_cls_results = self._train_model(
            transformer_cls, train_loader, test_loader, epochs=epochs,
            task="classification"
        )
        ...
        for persona in STRESS_PERSONAS:
            ...
            if len(X_p) > 0:
                ...
                print(f"  MAE: {results['per_persona_results'][persona.value]['mae']:.2f}")
        ...
        reg_models = {k: v for k, v in results["model_results"].items() if "regression" in k}
        best_reg = min(reg_models.items(), key=lambda x: x[1]["mae"])
        print(f"Best: {best_reg[0]} (MAE: {best_reg[1]['mae']:.2f}, R²: {best_reg[1]['r2']:.3f})")

        print("\n### Classification (Stress Category) ###")
        cls_models = {k: v for k, v in results["model_results"].items() if "classification" in k}
        best_cls = max(cls_models.items(), key=lambda x: x[1]["accuracy"])
        print(f"Best: {best_cls[0]} (Accuracy: {best_cls[1]['accuracy']:.3f}, F1: {best_cls[1]['f1_macro']:.3f})")

        print("\n### Top 5 Stress Predictors ###")
        for i, (feat, imp) in enumerate(list(results["feature_importance"].items())[:5], 1):
    ...
    def _prepare_sequences(
        ...
        feature_cols = [
            # HRV features
            "hrv_rmssd", "hrv_sdnn", "hrv_lf_hf_ratio", "pnn50",
            "hrv_rmssd_7d_avg",

            # RHR features
            "rhr", "rhr_deviation", "rhr_7d_avg",

            # Sleep features
            "sleep_duration", "sleep_quality", "sleep_efficiency",
            "deep_sleep_pct", "sleep_debt",

            # Activity features
            "activity_load", "workout_duration", "training_load_7d",

            # Nutrition features
            "nutrition_score", "late_eating", "meal_regularity",

            # Context features
            "is_weekend", "stress_event", "cumulative_stress",
        ]
        ...
        for persona in df["persona"].unique():
            persona_df = df[df["persona"] == persona].sort_values("date").reset_index(drop=True)

            X = persona_df[feature_cols].values
            y_reg = persona_df["stress_score"].values
            y_cls = persona_df["stress_category"].map({"LOW": 0, "MODERATE": 1, "HIGH": 2}).values
        ...
        if test_size > 0:
            ...
            return X, np.array([]), y_reg, np.array([]), y_cls, np.array([]), feature_cols
